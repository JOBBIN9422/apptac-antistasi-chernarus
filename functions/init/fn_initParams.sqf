...
A3A_paramTable = [
    ...
    ["playerMarkersEnabled", "pMarkers", [], false],
    ...
    ["helmetLossChance", "helmetLossChance", [], 66],
    ...
    ["crateWepTypeMax", "crateWepTypeMax", [], 4],
    ["crateWepNumMax", "crateWepNumMax", [], 3],
    ["crateItemTypeMax", "crateItemTypeMax", [], 2],
    ["crateItemNumMax", "crateItemNumMax", [], 3],
    ["crateAmmoTypeMax", "crateAmmoTypeMax", [], 4],
    ["crateAmmoNumMax", "crateAmmoNumMax", [], 10],
